 ...
 * @param <V> value type
 */
public class ReplicatedRecord<V> implements IdentifiedDataSerializable {
    ...
    public ReplicatedRecord(Data key, V value, int hash, long ttlMillis) {
        this.key = key;
        this.value = value;
