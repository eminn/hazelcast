...
public abstract class AbstractPutMessageTask<P> extends AbstractKeyBasedMessageTask<P> {

    protected transient long startTime;

    protected AbstractPutMessageTask(ClientMessage clientMessage, Node node, Connection connection) {
