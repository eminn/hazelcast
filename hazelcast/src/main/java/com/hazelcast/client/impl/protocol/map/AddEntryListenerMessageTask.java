...
public class AddEntryListenerMessageTask extends AbstractAddEntryListenerMessageTask<MapAddEntryListenerParameters> {


    public AddEntryListenerMessageTask(ClientMessage clientMessage, Node node, Connection connection) {
