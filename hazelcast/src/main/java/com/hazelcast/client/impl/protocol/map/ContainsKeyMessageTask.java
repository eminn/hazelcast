...
public class ContainsKeyMessageTask extends AbstractKeyBasedMessageTask<MapContainsKeyParameters> {

    public ContainsKeyMessageTask(ClientMessage clientMessage, Node node, Connection connection) {
