...
public class IsLockedMessageTask extends AbstractKeyBasedMessageTask<MapIsLockedParameters> {

    public IsLockedMessageTask(ClientMessage clientMessage, Node node, Connection connection) {
