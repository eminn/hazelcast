...
public class TryPutMessageTask extends AbstractPutMessageTask<MapTryPutParameters> {

    public TryPutMessageTask(ClientMessage clientMessage, Node node, Connection connection) {
