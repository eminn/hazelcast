...
public class AddInterceptorMessageTask extends AbstractMultiTargetMessageTask<MapAddInterceptorParameters> {

    private transient String id;

    public AddInterceptorMessageTask(ClientMessage clientMessage, Node node, Connection connection) {
