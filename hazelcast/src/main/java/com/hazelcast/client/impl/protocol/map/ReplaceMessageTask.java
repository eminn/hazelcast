...
public class ReplaceMessageTask extends AbstractPutMessageTask<MapReplaceParameters> {
    public ReplaceMessageTask(ClientMessage clientMessage, Node node, Connection connection) {
