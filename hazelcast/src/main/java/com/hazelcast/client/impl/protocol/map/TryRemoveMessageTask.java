...
public class TryRemoveMessageTask extends AbstractKeyBasedMessageTask<MapTryRemoveParameters> {

    public TryRemoveMessageTask(ClientMessage clientMessage, Node node, Connection connection) {
