...
public class ReplaceIfSameMessageTask extends AbstractPutMessageTask<MapReplaceIfSameParameters> {

    public ReplaceIfSameMessageTask(ClientMessage clientMessage, Node node, Connection connection) {
