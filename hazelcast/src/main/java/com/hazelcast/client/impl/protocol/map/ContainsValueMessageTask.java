...
public class ContainsValueMessageTask extends AbstractAllPartitionsMessageTask<MapContainsValueParameters> {

    public ContainsValueMessageTask(ClientMessage clientMessage, Node node, Connection connection) {
