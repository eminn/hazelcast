...
public class DeleteMessageTask extends AbstractKeyBasedMessageTask<MapDeleteParameters> {

    public DeleteMessageTask(ClientMessage clientMessage, Node node, Connection connection) {
