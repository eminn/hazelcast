...
public class AddNearCacheEntryListenerMessageTask
        extends AbstractAddEntryListenerMessageTask<MapAddNearCacheEntryListenerParameters> {

    public AddNearCacheEntryListenerMessageTask(ClientMessage clientMessage, Node node, Connection connection) {
