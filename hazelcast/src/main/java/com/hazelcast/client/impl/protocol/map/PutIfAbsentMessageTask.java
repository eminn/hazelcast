...
public class PutIfAbsentMessageTask extends AbstractPutMessageTask<MapPutIfAbsentParameters> {

    public PutIfAbsentMessageTask(ClientMessage clientMessage, Node node, Connection connection) {
