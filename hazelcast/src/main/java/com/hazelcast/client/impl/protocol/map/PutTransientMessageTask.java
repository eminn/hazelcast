...
public class PutTransientMessageTask extends AbstractPutMessageTask<MapPutTransientParameters> {

    public PutTransientMessageTask(ClientMessage clientMessage, Node node, Connection connection) {
