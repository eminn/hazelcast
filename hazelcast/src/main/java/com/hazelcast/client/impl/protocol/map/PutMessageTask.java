...
public class PutMessageTask extends AbstractPutMessageTask<MapPutParameters> {

    public PutMessageTask(ClientMessage clientMessage, Node node, Connection connection) {
