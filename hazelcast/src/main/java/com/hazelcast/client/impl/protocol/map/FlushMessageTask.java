...
public class FlushMessageTask extends AbstractAllPartitionsMessageTask<MapFlushParameters> {

    public FlushMessageTask(ClientMessage clientMessage, Node node, Connection connection) {
